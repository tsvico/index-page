...
if (storage.getItem('theme') !== '1' && storage.getItem('theme') !== '0') {
  if (window.matchMedia('(prefers-color-scheme: light)').matches || window.matchMedia('(prefers-color-scheme: no-preference)').matches) {
